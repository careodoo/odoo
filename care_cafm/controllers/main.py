...
class CafmMobile(http.Controller):
    ...
    def home(self, **kw):
        ...
        extra = [
            ...
            ('/cafm/m/svc/pest', '🐜', 'مكافحة الحشرات', 'برامج · زيارات · محطات · مبيدات'),
            ('/cafm/m/svc/pool', '🏊', 'صيانة المسابح', 'قراءات · نطاق آمن · صيانة'),
            ('/cafm/m/svc/watertank', '🚰', 'خزانات المياه', 'سجل · دورات · شهادات'),
            ('/cafm/m/svc/disinfection', '🧴', 'التعقيم', 'جولات · زمن تلامس · ATP'),
