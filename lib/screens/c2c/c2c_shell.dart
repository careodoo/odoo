  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: EdgeInsets.zero, children: [
        ...
        Padding(padding: EdgeInsets.fromLTRB(18, 10, 18, 4), child: Align(alignment: Alignment.centerRight,
            child: Text(tr('التفضيلات', 'Preferences'), style: TextStyle(fontWeight: FontWeight.w900, color: C2C.navy, fontSize: 15)))),
        tile(Icons.language_rounded, tr('اللغة', 'Language'), () => showLanguagePicker(context), c: const Color(0xFF16A34A)),
        Padding(padding: EdgeInsets.fromLTRB(18, 12, 18, 4), child: Align(alignment: Alignment.centerRight,
            child: Text(tr('عن التطبيق', 'About'), style: TextStyle(fontWeight: FontWeight.w900, color: C2C.navy, fontSize: 15)))),
        ...
        tile(Icons.info_outline_rounded, tr(tr('عن التطبيق', 'About'), 'About'), () => showAboutDialog(context: context,
