      ...
      items.add(Padding(
        ...
        child: Material(
          ...
          child: ListTile(
            ...
            title: Text(t, style: TextStyle(fontWeight: FontWeight.w700, color: danger ? _red : const Color(0xFF1F2A37))),
            trailing: const Icon(Icons.chevron_left_rounded, color: Color(0xFF64748B)),
