...
/// The flat roster: every worker serving the client's sites in one list, with
/// photo, live status and current location. Reached from the team blocks when
/// you want people rather than structure.
class ClientTeamRosterScreen extends StatefulWidget {
  const ClientTeamRosterScreen({super.key});
  @override
  State<ClientTeamRosterScreen> createState() => _ClientTeamRosterScreenState();
}

class _ClientTeamRosterScreenState extends State<ClientTeamRosterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(tr('كل العاملين', 'All workers'))),
