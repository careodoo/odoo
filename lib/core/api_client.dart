...
class ApiClient {
  ...
  /// Key hubs → keys in each → latest in/out logs (custody board).
  Future<List<dynamic>> securityKeyhubs() async =>
      List<dynamic>.from((await _handle(
              await _net.get(_u('/client/security/keyhubs'), headers: await _headers())))['data'] as List);
  ...
  Future<Map<String, dynamic>> pmsItemRequest(int id) async =>
      Map<String, dynamic>.from((await _handle(await _net.get(
          _u('/pms/item-request/$id'), headers: await _headers())))['data'] as Map);

  Future<Map<String, dynamic>> pmsItemRequestCreate(int projectId, Map<String, dynamic> body) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/project/$projectId/item-request/create'), headers: await _headers(),
          body: jsonEncode(body))))['data'] as Map);

  Future<Map<String, dynamic>> pmsItemRequestAction(int id, String act, {String? reason}) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/item-request/$id/$act'), headers: await _headers(),
  ...
  Future<Map<String, dynamic>> pmsPermit(int id) async =>
      Map<String, dynamic>.from((await _handle(await _net.get(
          _u('/pms/permit/$id'), headers: await _headers())))['data'] as Map);

  Future<Map<String, dynamic>> pmsPermitCreate(int projectId, Map<String, dynamic> body) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/project/$projectId/permit/create'), headers: await _headers(),
          body: jsonEncode(body))))['data'] as Map);

  Future<Map<String, dynamic>> pmsPermitAction(int id, String act) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/permit/$id/$act'), headers: await _headers())))['data'] as Map);
  ...
  Future<Map<String, dynamic>> pmsFuel(int id) async =>
      Map<String, dynamic>.from((await _handle(await _net.get(
          _u('/pms/fuel/$id'), headers: await _headers())))['data'] as Map);

  Future<Map<String, dynamic>> pmsFuelUpdate(int id, Map<String, dynamic> body) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/fuel/$id/update'), headers: await _headers(),
          body: jsonEncode(body))))['data'] as Map);

  Future<Map<String, dynamic>> pmsFuelAction(int id, String act) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
          _u('/pms/fuel/$id/$act'), headers: await _headers())))['data'] as Map);

  String pmsFuelReportPath(int id) => '/pms/fuel/$id/report';
  ...
  Future<Map<String, dynamic>> pmsPettySettlement(int cashId, Map<String, dynamic> body) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
              _u('/pms/pettycash/$cashId/settlement'), headers: await _headers(),
              body: jsonEncode(body))))['data'] as Map);
  ...
  Future<Map<String, dynamic>> managementProposalMeta() async =>
      Map<String, dynamic>.from((await _handle(await _net.get(
              _u('/management/proposals/meta'), headers: await _headers())))['data'] as Map);

  /// Create a new proposal (quotation). Returns {id, ref, title}.
  Future<Map<String, dynamic>> managementProposalCreate(Map<String, dynamic> vals) async =>
      Map<String, dynamic>.from((await _handle(await _net.post(
  ...
  Future<Map<String, dynamic>> managementAnalytics({String period = 'all'}) async =>
      Map<String, dynamic>.from((await _handle(await _net.get(
              _u('/management/analytics?period=$period'), headers: await _headers())))['data'] as Map);
  ...
  Future<Map<String, dynamic>> myHub() async =>
      Map<String, dynamic>.from((await _handle(
              await _net.get(_u('/my/hub'), headers: await _headers())))['data'] as Map);
