{
    ...
    'version':
        '17.0.0.0.0',
    'depends': ['base', 'mail', 'purchase_requisition', 'care_experience'],
    'data': [
        'security/groups.xml',
        'security/ir.model.access.csv',
        'security/rules.xml',
        'data/tender.xml',
        'data/tender_classification_data.xml',
        'data/mail_templates.xml',
        'data/tender_cron.xml',
        'views/tender_classification_views.xml',
        'views/care_experience_bridge.xml',
        'views/purchase_tender.xml',
        'views/bid_type.xml',
        'views/tender_follower.xml',
        'views/tender_notification.xml',
