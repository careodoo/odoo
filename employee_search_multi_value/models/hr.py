...
class HRSearchMultiMixin(models.AbstractModel):
    _name = "hr.search.multi.mixin"
    _description = "HR search multi value mixin"
    ...
    def _get_search_fields(self):
        try:
            search_fields = (
                ...
                .sudo()
                .get_param("employee_search_multi_value.search_fields")
            )
...
class HrEmoloyee(models.Model):
    _inherit = ["hr.employee", "hr.search.multi.mixin"]
    _name = "hr.employee"
